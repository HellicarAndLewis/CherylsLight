...
void ofApp::setup(){
    ...
    gui.add(speed.set("Speed", 0, -1, 1));
    gui.add(sentSpeed.set("Sent", 0, 0, 256));
...
void ofApp::update(){
	...
	//if (bSendSerialMessage){
        ...
        Byte buf[NUM_MOTORS];
        Byte speedToSend = ofMap(speed, -1, 1, 0, 255, true);
        ...
        sentSpeed.set(speedToSend);
		serial.writeBytes(&buf[0], NUM_MOTORS);
        ofSleepMillis(50);
